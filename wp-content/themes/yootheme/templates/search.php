...
// Style
if (in_array($position, ['navbar', 'header'])) {
...
// Toggle
if ($style == 'modal') {
    if ((strrpos($layout, 'horizontal-', 0) !== false) || (strrpos($layout, 'stacked-', 0) !== false && $position == 'navbar')) {
        // TODO has to be set in module.php instead of `uk-navbar-item`
